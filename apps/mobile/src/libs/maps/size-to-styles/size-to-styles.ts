...
const sizeToStyles = {
	...
	xs: { borderRadius: 44, height: 44, width: 44 } satisfies ViewStyle,
	xxs: { borderRadius: 34, height: 34, width: 34 } satisfies ViewStyle,
	xxxs: { borderRadius: 11, height: 11, width: 11 } satisfies ViewStyle,
};
